...
@optendersresource(name='Award complaint ownership',
...
class AwardComplaintOwnershipResource(APIResource):
    ...
    def post(self):
        ...
        location = self.request.route_path('belowThreshold:Tender Award Complaints', tender_id=tender.id, award_id=award_id, complaint_id=complaint.id)
